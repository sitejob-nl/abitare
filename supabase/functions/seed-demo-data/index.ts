...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const quotes = [
      { id: "q0000001-0000-0000-0000-000000000001", customer_id: customers[0].id, division_id: divisionId, status: "concept", quote_number: 9001, reference: "de Vries - Keuken - 2026-001", subtotal: 12500, total_excl_vat: 12500, total_vat: 2625, total_incl_vat: 15125, created_at: daysAgo(2) },
      { id: "q0000001-0000-0000-0000-000000000002", customer_id: customers[1].id, division_id: divisionId, status: "verstuurd", quote_number: 9002, reference: "Bakker - Keuken - 2026-001", subtotal: 18750, total_excl_vat: 18750, total_vat: 3937.50, total_incl_vat: 22687.50, created_at: daysAgo(5), sent_at: daysAgo(4) },
      { id: "q0000001-0000-0000-0000-000000000003", customer_id: customers[2].id, division_id: divisionId, status: "geaccepteerd", quote_number: 9003, reference: "Jansen Bouw - Keuken - 2026-001", subtotal: 32500, total_excl_vat: 32500, total_vat: 6825, total_incl_vat: 39325, created_at: daysAgo(14), sent_at: daysAgo(13), accepted_at: daysAgo(7) },
      { id: "q0000001-0000-0000-0000-000000000004", customer_id: customers[3].id, division_id: divisionId, status: "bekeken", quote_number: 9004, reference: "van den Berg - Keuken - 2026-001", subtotal: 15800, total_excl_vat: 15800, total_vat: 3318, total_incl_vat: 19118, created_at: daysAgo(3), sent_at: daysAgo(2) },
      { id: "q0000001-0000-0000-0000-000000000005", customer_id: customers[4].id, division_id: divisionId, status: "vervallen", quote_number: 9005, reference: "Willems - Keuken - 2026-001", subtotal: 9200, total_excl_vat: 9200, total_vat: 1932, total_incl_vat: 11132, created_at: daysAgo(45), sent_at: daysAgo(44) },
      { id: "q0000001-0000-0000-0000-000000000006", customer_id: customers[5].id, division_id: divisionId, status: "verstuurd", quote_number: 9006, reference: "Hendriks - Keuken - 2026-001", subtotal: 21300, total_excl_vat: 21300, total_vat: 4473, total_incl_vat: 25773, created_at: daysAgo(1), sent_at: daysAgo(0) },
      { id: "q0000001-0000-0000-0000-000000000007", customer_id: customers[9].id, division_id: divisionId, status: "geaccepteerd", quote_number: 9007, reference: "de Groot - Keuken - 2026-001", subtotal: 28900, total_excl_vat: 28900, total_vat: 6069, total_incl_vat: 34969, created_at: daysAgo(20), sent_at: daysAgo(19), accepted_at: daysAgo(12) },
      { id: "q0000001-0000-0000-0000-000000000008", customer_id: customers[11].id, division_id: divisionId, status: "concept", quote_number: 9008, reference: "Meijer - Keuken - 2026-001", subtotal: 16400, total_excl_vat: 16400, total_vat: 3444, total_incl_vat: 19844, created_at: daysAgo(0) },
    ];
    ...
    const quoteSections = [
      { id: "qs000001-0000-0000-0000-000000000001", quote_id: quotes[0].id, title: "Keukenkasten Stosa", section_type: "keuken", sort_order: 1, range_id: null, supplier_id: stosaId },
      { id: "qs000001-0000-0000-0000-000000000002", quote_id: quotes[0].id, title: "Apparatuur", section_type: "apparatuur", sort_order: 2, range_id: null, supplier_id: siemensId },
      { id: "qs000001-0000-0000-0000-000000000003", quote_id: quotes[1].id, title: "Keukenkasten Stosa", section_type: "keuken", sort_order: 1, range_id: null, supplier_id: stosaId },
      { id: "qs000001-0000-0000-0000-000000000004", quote_id: quotes[1].id, title: "Apparatuur Miele", section_type: "apparatuur", sort_order: 2, range_id: null, supplier_id: mieleId },
      { id: "qs000001-0000-0000-0000-000000000005", quote_id: quotes[2].id, title: "Keukenkasten Stosa", section_type: "keuken", sort_order: 1, range_id: null, supplier_id: stosaId },
      { id: "qs000001-0000-0000-0000-000000000006", quote_id: quotes[2].id, title: "Apparatuur", section_type: "apparatuur", sort_order: 2, range_id: null, supplier_id: mieleId },
      { id: "qs000001-0000-0000-0000-000000000007", quote_id: quotes[2].id, title: "Werkblad & Spoelbak", section_type: "werkblad", sort_order: 3, range_id: null, supplier_id: blancoId },
    ];
    ...
    const orderLines = [
      ...
      // Order 5 (montage_gepland - Mulder)
